            ...
            <div className="offset-lg-3 col-lg-6">
                ...
                <form>
                    <div className="mb-3">
                        ...
                        <input onChange={(e) => setNome(e.target.value)} type="text" className="form-control" id="exampleInputEmail1" />
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <input onChange={(e) => setFone(e.target.value)} type="text" className="form-control" id="exampleInputEmail1" />
                    </div>
